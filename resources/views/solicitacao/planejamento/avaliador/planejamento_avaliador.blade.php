    ...
    <form id="form6" method="POST" action="{{route('solicitacao.planejamento.criar')}}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <input class="form-control" id="num_animais_grupo"
            ...
            <div class="col-sm-5">
                ...
                <textarea class="form-control" id="especificar_grupo"
            ...
            <div class="col-sm-5">
                ...
                <textarea class="form-control" id="criterios" name="criterios"
        ...
        <div class="row mt-2">
            <div class="col-sm-12">
                ...
                <textarea class="form-control" id="outras_infos"
