<div class="card shadow-lg p-3 bg-white" style="border-radius: 10px">
    ...
    <form method="POST" action="{{route('solicitacao.planejamento.criar')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <input class="form-control @error('num_animais_grupo') is-invalid @enderror" id="num_animais_grupo" type="number" name="num_animais_grupo" value="{{ old('num_animais_grupo') }}"
                       required
