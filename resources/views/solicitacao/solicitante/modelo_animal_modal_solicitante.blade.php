                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control @if ($errors->modelo->has('nome_cientifico')) is-invalid @endif"
                                id="nome_cientifico" type="text" name="nome_cientifico"
                                @if (isset($modelo_animal)) value="{{ $modelo_animal->nome_cientifico }}"
               @else value="{{ old('nome_cientifico') }}" @endif
                                required autocomplete="nome_cientifico" autofocus>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control @if ($errors->modelo->has('nome_vulgar')) is-invalid @endif"
                                id="nome_vulgar" type="text" name="nome_vulgar"
                                @if (isset($modelo_animal)) value="{{ $modelo_animal->nome_vulgar }}"
               @else value="{{ old('nome_vulgar') }}" @endif
                                required autocomplete="nome_vulgar" autofocus>
                        ...
                        <div class="col-sm-12 mt-2">
                            <label for="justificativa">Justificar o uso dos Procedimentos e da Espécie Animal:<strong
                                    style="color: red">*</strong></label>
                            <textarea class="form-control @if ($errors->modelo->has('justificativa')) is-invalid @endif" id="justificativa"
                                name="justificativa"
                                @if (isset($modelo_animal)) value="{{ $modelo_animal->justificativa }}" @else value="{{ old('justificativa') }}" @endif
                                required autocomplete="justificativa" autofocus></textarea>
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <select class="form-control @if ($errors->modelo->has('procedencia')) is-invalid @endif"
                                    id="procedencia" name="procedencia">
                                    <option class="default" disabled selected>Selecione a Procedência</option>
                                    <option value="animal_comprado" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'animal_comprado') selected @endif>
                                        Animal comprado
                                    </option>
                                    <option value="animal_criacao" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'animal_criacao') selected @endif>
                                        Animal de criação ou de casuística hospitalar
                                    </option>
                                    <option value="animal_doado" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'animal_doado') selected @endif>
                                        Animal doado
                                    </option>
                                    <option value="animal_silvestre" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'animal_silvestre') selected @endif>
                                        Animal Silvestre
                                    </option>
                                    <option value="aviario" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'aviario') selected @endif>Aviário
                                    </option>
                                    <option value="bioterio" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'bioterio') selected @endif>Biotério
                                    </option>
                                    <option value="fazenda" @if (isset($modelo_animal) && $modelo_animal->procedencia == 'fazenda') selected @endif>Fazenda
                                    </option>
                            ...
                            <div class="col-sm-3" id="anexo_outra_procedencia" style="display: none;">
                                ...
                                <input class="form-control @error('') is-invalid @enderror"
                                    name="tipo_outra_procedencia" id="tipo_outra_procedencia"
                                    autocomplete="tipo_outra_procedencia" autofocus required
                                    @if (isset($modelo_animal->perfil) && $modelo_animal->tipo_outra_procedencia != null) value="{{ $modelo_animal->tipo_outra_procedencia }}" @endif>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mt-2" id="anexo_animal_silvestre_captura">
                                    ...
                                    <div class="row ml-1">
                                        ...
                                        <div class="div_error" id="flag_captura_cientifico_error"
                                            style="display: none">
                                            <span class="invalid-input">
                                        ...
                                        <div class="col-sm-13 mt-2" id="anexo_captura" style="display: none;">
                                            <label for="anexo_captura">Descreva:<strong
                                                    style="color: red">*</strong></label>
                                            <input class="form-control @error('captura') is-invalid @enderror"
                                                id="captura" type="text" name="captura"
                                                @if (isset($modelo_animal) && $modelo_animal->captura != null) value="{{ $modelo_animal->captura }}"
                        @else value="{{ old('captura') }}" @endif
                                                required autocomplete="captura" autofocus>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row ml-1">
                                        <div class="col-sm-2">
                                            <input class="form-check-input" type="radio"
                                                name="flag_coleta_especimes" id="coleta_especimes_sim" value="true"
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-check-input" type="radio"
                                                name="flag_coleta_especimes" id="coleta_especimes_nao" value="false"
                                                @if (isset($modelo_animal) && !$modelo_animal->flag_coleta_especimes) checked @endif>
                                            <label class="form-check-label" for="flag_coleta_especimes">
                                                Não
                                            </label>
                                        </div>
                                        <div class="div_error" id="flag_coleta_especimes_error"
                                            style="display: none">
                                            <span class="invalid-input">
                                                <strong id="flag_coleta_especimes_error_message"></strong>
                                            </span>
                                        </div>
                                        <div class="col-sm-13 mt-2" id="anexo_coleta_especimes"
                                            style="display: none;">
                                            <label for="anexo_coleta_especimes">Descreva:<strong
                                                    style="color: red">*</strong></label>
                                            <input
                                                class="form-control @error('coleta_especimes') is-invalid @enderror"
                                                id="coleta_especimes" type="text" name="coleta_especimes"
                                                @if (isset($modelo_animal) && $modelo_animal->coleta_especimes != null) value="{{ $modelo_animal->coleta_especimes }}"
                        @else value="{{ old('coleta_especimes') }}" @endif
                                                required autocomplete="coleta_especimes" autofocus>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 mt-2" id="anexo_animal_marcacao">
                                    ...
                                    <div class="row ml-1">
                                        ...
                                        <div class="col-sm-13 mt-2" id="anexo_marcacao" style="display: none;">
                                            <label for="anexo_marcacao">Descreva:<strong
                                                    style="color: red">*</strong></label>
                                            <input class="form-control @error('marcacao') is-invalid @enderror"
                                                id="marcacao" type="text" name="marcacao"
                                                @if (isset($modelo_animal) && $modelo_animal->marcacao != null) value="{{ $modelo_animal->marcacao }}"
                        @else value="{{ old('marcacao') }}" @endif
                                                required autocomplete="marcacao" autofocus>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 mt-2" id="anexo_outras_informações">
                                    ...
                                    <div class="row ml-1">
                                        ...
                                        <div class="col-sm-13 mt-2" id="anexo_outras_info" style="display: none;">
                                            <label for="anexo_outras_info">Descreva:<strong
                                                    style="color: red">*</strong></label>
                                            <input class="form-control @error('outras_info') is-invalid @enderror"
                                                id="outras_info" type="text" name="outras_info"
                                                @if (isset($modelo_animal) && $modelo_animal->outras_info != null) value="{{ $modelo_animal->outras_info }}"
                        @else value="{{ old('outras_info') }}" @endif
                                                required autocomplete="outras_info" autofocus>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 mt-2">
                                <label for="experiencia">O Animal é Geneticamente Modificado?<strong
                                        style="color: red">*</strong></label>
                                <div class="row ml-1">
                                    <div class="col-sm-2">
                                        <input class="form-check-input" type="radio"
                                            name="geneticamente_modificado" id="geneticamente_modificado_sim"
                                    ...
                                    <div class="col-sm-2">
                                        <input class="form-check-input default" type="radio"
                                            name="geneticamente_modificado" id="geneticamente_modificado_nao"
                                    ...
                                    <div class="col-sm-4" id="anexo_cqb" style="display: none;">
                                        <label for="anexo_cqb">Número CQB:<strong
                                                style="color: red">*</strong></label>
                                        <input class="form-control @error('numero_cqb') is-invalid @enderror"
                                            id="numero_cqb" type="number" name="numero_cqb"
                                            @if (isset($modelo_animal) && $modelo_animal->numero_cqb != null) value="{{ $modelo_animal->numero_cqb }}"
                    @else value="{{ old('numero_cqb') }}" @endif
                                            required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control @if ($errors->modelo->has('grupo_animal')) is-invalid @endif"
                                    id="grupo_animal" name="grupo_animal" required>
                                    <option class="default" disabled selected>Selecione o Grupo Animal</option>
                                    <option value="anfibio" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'anfibio') selected @endif>
                                        Anfíbio
                                    </option>
                                    <option value="ave" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'ave') selected @endif>
                                        Ave
                                    </option>
                                    <option value="bovino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'bovino') selected @endif>
                                        Bovino
                                    </option>
                                    <option value="bubalino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'bubalino') selected @endif>
                                        Bubalino
                                    </option>
                                    <option value="canino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'canino') selected @endif>
                                        Canino
                                    </option>
                                    ...
                                    <option value="caprino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'caprino') selected @endif>
                                        Caprino
                                    </option>
                                    <option value="chinchila" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'chinchila') selected @endif>
                                        Chinchila
                                    </option>
                                    <option value="cobaia" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'cobaia') selected @endif>
                                        Cobaia
                                    </option>
                                    <option value="coelhos" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'coelhos') selected @endif>
                                        Coelhos
                                    </option>
                                    <option value="equideo" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'equideo') selected @endif>
                                        Equídeo
                                    </option>
                                    ...
                                    <option value="gato" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'gato') selected @endif>
                                        Gato
                                    </option>
                                    <option value="gerbil" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'gerbil') selected @endif>
                                        Gerbil
                                    </option>
                                    <option value="hamster" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'hamster') selected @endif>
                                        Hamster
                                    </option>
                                    <option value="ovino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'ovino') selected @endif>
                                        Ovino
                                    </option>
                                    <option value="peixe" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'peixe') selected @endif>
                                        Peixe
                                    </option>
                                    ...
                                    <option value="rato_isogenico" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'rato_isogenico') selected @endif>
                                        Rato Isogênico
                                    </option>
                                    <option value="rato_knockout" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'rato_knockout') selected @endif>
                                        Rato Knockout
                                    </option>
                                    ...
                                    <option value="reptil" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'reptil') selected @endif>
                                        Réptil
                                    </option>
                                    <option value="suino" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'suino') selected @endif>
                                        Suíno
                                    </option>
                                    <option value="outro" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->grupo_animal == 'outro') selected @endif>
                                        Outro a especificar
                                    </option>
                                </select>
                            ...
                            <div class="col-sm-3" id="anexo_outro_tipo" style="display: none;">
                                ...
                                <input class="form-control @error('') is-invalid @enderror" name="tipo_grupo_animal"
                                    autocomplete="tipo_grupo_animal" autofocus required
                                    @if (!empty($modelo_animal->perfil) && $modelo_animal->perfil->tipo_grupo_animal != null) value="{{ $modelo_animal->perfil->tipo_grupo_animal }}" @endif>
                            </div>

                            <div class="col-sm-6">
                                <label for="linhagem">Linhagem / Raça:<strong style="color: red">*</strong></label>
                                <input class="form-control @if ($errors->modelo->has('linhagem')) is-invalid @endif"
                                    id="linhagem" type="text" name="linhagem"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->linhagem }}" @else
                       value="{{ old('linhagem') }}" @endif
                                    required autocomplete="linhagem" autofocus>
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-4 pr-0">
                                ...
                                <input class="form-control @if ($errors->modelo->has('idade')) is-invalid @endif"
                                    id="idade" type="number" name="idade"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->idade }}"
                   @else value="{{ old('idade') }}" @endif
                                    required autocomplete="idade" autofocus>
                            ...
                            <div class="col-sm-2 pl-1">
                                ...
                                <select class="form-control" name="periodo" autofocus>
                                    <option class="default" value="Dias"
                                        @if (
                                            (isset($modelo_animal->perfil) && $modelo_animal->perfil->periodo == 'Dias') ||
                                                (isset($modelo_animal->perfil) && $modelo_animal->perfil->periodo == null)) selected @endif>
                                        Dias
                                    </option>
                                    <option value="Meses" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->periodo == 'Meses') selected @endif>
                                        Meses
                                    </option>
                                    <option value="Anos" @if (isset($modelo_animal->perfil) && $modelo_animal->perfil->periodo == 'Anos') selected @endif>
                                        Anos
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @if ($errors->modelo->has('peso')) is-invalid @endif"
                                    id="peso" type="text" name="peso"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->peso }}"
                   @else value="{{ old('peso') }}" placeholder="Ex: 30 kg" @endif
                                    required autocomplete="peso" autofocus>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-4">
                                <label for="machos">Quantidade de Machos:<strong
                                        style="color: red">*</strong></label>
                                <input class="form-control @if ($errors->modelo->has('machos')) is-invalid @endif"
                                    id="machos" type="number" name="machos"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->machos }}"
                   @else value="{{ old('machos') }}" @endif
                                    required autocomplete="machos" autofocus>
                            ...
                            <div class="col-sm-4">
                                <label for="femeas">Quantidade de Fêmeas:<strong
                                        style="color: red">*</strong></label>
                                <input class="form-control @if ($errors->modelo->has('femeas')) is-invalid @endif"
                                    id="femeas" type="number" name="femeas"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->femeas }}"
                   @else value="{{ old('femeas') }}" @endif
                                    required autocomplete="femeas" autofocus>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input class="form-control @if ($errors->modelo->has('quantidade')) is-invalid @endif"
                                    id="quantidade" type="number" name="quantidade"
                                    @if (isset($modelo_animal->perfil)) value="{{ $modelo_animal->perfil->quantidade }}"
                   @else value="{{ old('quantidade') }}" @endif
                                    required autocomplete="quantidade" autofocus readonly>
                            ...
                            <div class="col-sm-12 mt-3">
                                ...
                                <textarea class="form-control @error('observacao') is-invalid @enderror" id="observacao" name="observacao"
                                    rows="3">{{ isset($modelo_animal->perfil) ? $modelo_animal->perfil->observacao : old('observacao') }}</textarea>
                            ...
                            <div class="col-sm-12 mt-3">
                                <label for="termo_consentimento">Termo de Consentimento Livre e Esclarecido
                                    (TCLE):<strong style="color: red">*</strong></label>
                                @if (!empty($modelo_animal))
                                    <input class="form-control @error('termo_consentimento') is-invalid @enderror"
                                        id="termo_consentimento" type="file" accept="application/pdf"
                                        name="termo_consentimento" value="" autocomplete="termo_consentimento"
                                        autofocus @if ($modelo_animal->termo_consentimento != null) style="width: 135px" @endif>
                        ...
                        @else value="{{ old('termo_consentimento') }}" @endif
                                        autocomplete="termo_consentimento" autofocus required>
                                    <div class="div_error" id="termo_consentimento_error" style="display: none">
                                        <span class="invalid-input">
                                            <strong id="termo_consentimento_error_message"></strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mt-3">
                                <label for="licencas_previas">Licenças Prévias de outras instituições (IBAMA, FUNAI,
                                    CNEN, CTNBio, CGEN, ICMBio.):</label>
                                ...
                                @if (!empty($modelo_animal))
                                    <input class="form-control" id="licencas_previas" type="file"
                                        accept="application/pdf" name="licencas_previas" value=""
                                        autocomplete="licencas_previas"
                                ...
                                @else
                                    <input class="form-control" id="licencas_previas" type="file"
                                        accept="application/pdf" name="licencas_previas"
                                        @if (isset($modelo_animal)) value="{{ $modelo_animal->licencas_previas }}"
                           @else value="{{ old('licencas_previas') }}" @endif
                                        autocomplete="licencas_previas">
                                @endif
    ...
    $(document).ready(function() {
        ...
        $("#procedencia").change(function() {
            if ($(this).val() == "animal_silvestre") {
                $("#anexo_animal_silvestre_captura").show().find('input, radio').prop('disabled',
                    false);
        ...
        @if (isset($modelo_animal) && $modelo_animal->procedencia == 'animal_silvestre')
            $("#procedencia").change(function() {
                if ($(this).val() == "animal_silvestre") {
                    $("#anexo_animal_silvestre_captura").show().find('input, radio').prop('disabled',
                        false);
                    $("#anexo_animal_silvestre_coleta").show().find('input, radio').prop('disabled',
                        false);
                    $("#anexo_animal_marcacao").show().find('input, radio').prop('disabled', false);
                    $("#anexo_outras_informações").show().find('input, radio').prop('disabled', false);
                } else {
                    $("#anexo_animal_silvestre_captura").hide().find('input, radio').prop('disabled',
                        true);
                    $("#anexo_animal_silvestre_coleta").hide().find('input, radio').prop('disabled',
                        true);
                    $("#anexo_animal_marcacao").hide().find('input, radio').prop('disabled', true);
                    $("#anexo_outras_informações").hide().find('input, radio').prop('disabled', true);
                }
