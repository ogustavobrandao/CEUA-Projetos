<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #972E3F">
            ...
            @if (Auth::check() && Auth::user()->hasRole('Administrador'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('instituicao.index') }}"
                        style="color: white;">{{ __('Instituições') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('solicitacao.admin.index') }}"
                        style="color: white;">{{ __('Solicitações') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('usuarios.index') }}"
                        style="color: white;">{{ __('Usuários') }}</a>
                </li>
            @endif
        </ul>
                ...
                @if (Route::has('login'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white"
                            href="{{ route('calendarioReunioes') }}">{{ __('Calendário de reuniões') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white"
                            href="{{ route('fluxograma_documentos') }}">{{ __('Fluxograma de submissão e documentos') }}</a>
                    </li>
                    <li class="nav-item">
            ...
            @else
                ...
                <li class="nav-item dropdown">
                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle text-white" href="#" role="button"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v- style="color: black">
