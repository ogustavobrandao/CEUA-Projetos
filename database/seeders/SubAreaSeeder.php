...
class SubAreaSeeder extends Seeder
{
    ...
    {	
        ...
        DB::table('sub_areas')->insert([
        	'nome'=>'Probabilidade e Estatística Aplicadas',
        	'area_id' => '2'
      	]);
        DB::table('sub_areas')->insert([
        ...
        DB::table('sub_areas')->insert([
        	'nome'=>'Astrofísica Extragaláctica',
        	'area_id' => '4'
      	]);
        DB::table('sub_areas')->insert([
        ...
        DB::table('sub_areas')->insert([
        	'nome'=>'Física Atômica e Molécular',
        	'area_id' => '5'
      	]);
        DB::table('sub_areas')->insert([
        	'nome'=>'Física dos Fluidos, Física de Plasmas e Descargas Elétricas',
        	'area_id' => '5'
      	]);
        DB::table('sub_areas')->insert([
        ...
        //------------------ Ciências Biológicas  ----------------
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Genética Vegetal',
        	'area_id' => '10'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Genética Animal',
        	'area_id' => '10'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Genética Humana e Médica',
        	'area_id' => '10'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Mutagênese',
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Morfologia dos Grupos Recentes',
        	'area_id' => '12'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Fisiologia dos Grupos Recentes',
        	'area_id' => '12'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Taxonomia dos Grupos Recentes',
        	'area_id' => '12'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Citologia e Biologia Celular',
        	'area_id' => '14'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Embriologia',
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Fisiologia Geral',
        	'area_id' => '15'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Fisiologia de Órgaos e Sistemas',
        	'area_id' => '15'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Bioquímica dos Microorganismos',
        	'area_id' => '16'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Metabolismo e Bioenergética',
        	'area_id' => '16'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Biofísica Molecular',
        	'area_id' => '17'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Biofísica Celular',
        	'area_id' => '17'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Biofísica de Processos e Sistemas',
        	'area_id' => '17'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Radiologia e Fotobiologia',
        	'area_id' => '17'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Aplicações de Radioisotopos',
        	'area_id' => '30'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Tecnologia de Construção Naval e de Sistemas Oceânicas',
        	'area_id' => '32'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Aerodinâmica',
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Radiologia Médica',
        	'area_id' => '35'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Medicina Legal e Deontologia',
        	'area_id' => '35'
      	]);
        DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Análise e Controle e Medicamentos',
        	'area_id' => '37'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Bromatologia',
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Desnutrição e Desenvolvimento Fisiológico',
        	'area_id' => '39'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Epidemiologia',
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Energia de Biomassa Florestal',
        	'area_id' => '45'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Máquinas e Implementos Agrícolas',
        	'area_id' => '46'
      	]);
      	DB::table('sub_areas')->insert([
        ...
        DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Administração de Setores Específicos',
        	'area_id' => '52'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Projeto de Arquitetuta e Urbanismo',
        	'area_id' => '54'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Fontes de Dados Demográficos',
        	'area_id' => '56'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Relações Públicas e Propaganda',
        	'area_id' => '59'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Fundamentos do Serviço Social',
        	'area_id' => '60'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Sociologia do Conhecimento',
        	'area_id' => '65'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Sociologia da Saúde',
        	'area_id' => '65'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Outras Sociologias Específicas',
        	'area_id' => '65'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Teoria Antropológica',
        	'area_id' => '66'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'Teoria e Método em Arqueologia',
        	'area_id' => '67'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Arqueologia Pré-Histórica',
        	'area_id' => '67'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'Arqueologia Histórica',
        	'area_id' => '67'
      	]);
      	DB::table('sub_areas')->insert([
      	...
      	DB::table('sub_areas')->insert([
        	'nome'=>'História Antiga e Medieval',
        	'area_id' => '68'
      	]);
      	DB::table('sub_areas')->insert([
        	'nome'=>'História Moderna e Contemporânea',
        	'area_id' => '68'
      	]);
      	DB::table('sub_areas')->insert([
	...
	DB::table('sub_areas')->insert([
        	'nome'=>'Fisiologia da Linguagem',
        	'area_id' => '74'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Lingüística Histórica',
        	'area_id' => '74'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Sociolingüística e Dialetologia',
        	'area_id' => '74'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Psicolingüística',
        	'area_id' => '74'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Lingüística Aplicada',
        	'area_id' => '74'
      	]);
	DB::table('sub_areas')->insert([
	...
	DB::table('sub_areas')->insert([
        	'nome'=>'Línguas Estrangeiras Modernas',
        	'area_id' => '75'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Línguas Clássicas',
        	'area_id' => '75'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Línguas Indígenas',
        	'area_id' => '75'
      	]);
	DB::table('sub_areas')->insert([
        	'nome'=>'Teoria Literária',
        	'area_id' => '75'
      	]);
	DB::table('sub_areas')->insert([
	...
	DB::table('sub_areas')->insert([
        	'nome'=>'Outras Literaturas Vernáculas',
        	'area_id' => '75'
      	]);
	DB::table('sub_areas')->insert([
