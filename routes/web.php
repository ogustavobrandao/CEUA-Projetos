...
Route::group(['middleware' => 'checkProprietario'], function () {
    ...
    Route::get('/solicitacao/planejamento/index/{modelo_animal_id}', [App\Http\Controllers\SolicitacaoController::class, 'index_planejamento'])->name('solicitacao.planejamento.index.2');
