                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome" class="form-control" id="nome" placeholder="Digite o nome do colaborador" value="{{$colaborador->nome}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Digite o e-mail do colaborador" value="{{$colaborador->contato->email ?? 'Não informado'}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cpf" class="form-control cpf" id="cpf" placeholder="Digite o CPF do colaborador" value="{{$colaborador->cpf}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefone" class="form-control telefone" id="telefone" placeholder="Digite o telefone do colaborador" value="{{$colaborador->contato->telefone ?? 'Não Informado'}}" disabled>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="grau_escolaridade">Grau de Escolaridade:<strong
                                        style="color: red">*</strong></label>
                                <select class="form-control" id="grau_escolaridade" name="grau_escolaridade" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="row" id="divTreinamento-{{$colaborador->id}}"  @if($colaborador->treinamento == 'Não') style="display: none;" @endif>
                                <div class="col-sm-12 mt-2">
                                    ...
                                    required autocomplete="treinamento" autofocus disabled>
                                </div>
                            </div>
                        </div>
