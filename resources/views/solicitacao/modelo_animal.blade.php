        ...
        <div class="col-sm-6">
            ...
            <div class="row ml-1">
                ...
                <div class="col-sm-4" id="anexo_cqb" style="display: none;">
                    ...
                    <input class="form-control @error('numero_cqb') is-invalid @enderror" name="numero_cqb" id="numero_cqb" autocomplete="numero_cqb" autofocus
                              required @if(!empty($modelo_animal) && !$modelo_animal->numero_cqb != null){{ $modelo_animal->numero_cqb }} @else{{old('numero_cqb')}} @endif>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        @if(isset($modelo_animal) && !$modelo_animal->geneticamente_modificado != null)
