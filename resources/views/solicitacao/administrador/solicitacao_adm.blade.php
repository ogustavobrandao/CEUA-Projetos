        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <input class="form-control" id="inicio" type="date"
                       name="inicio" value="{{$solicitacao->inicio}}" autocomplete="inicio">
            </div>

            <div class="col-sm-4">

                <label for="inicio">Fim:<strong style="color: red">*</strong></label>
                <input class="form-control" id="fim" type="date" name="fim"
                       value="{{$solicitacao->fim}}" autocomplete="fim" autofocus>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <textarea class="form-control" id="titulo_pt"
                       name="titulo_pt" autocomplete="titulo_pt">{{$solicitacao->titulo_pt}}</textarea>
            </div>

            <div class="col-sm-5">
                <label for="titulo_en">Titulo em Inglês (apenas para projeto):</label>
                <textarea class="form-control" id="titulo_en"
                       name="titulo_en" autofocus>{{$solicitacao->titulo_en ?? ''}}</textarea>
            </div>
